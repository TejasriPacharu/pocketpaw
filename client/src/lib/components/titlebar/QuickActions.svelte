<!--
  QuickActions.svelte — Title bar quick action buttons (new chat, search, notifications, side panel)
  Modified: 2026-03-21 — Hide the Side Panel toggle in web mode (separate Tauri window, not applicable in browser)
-->
<script lang="ts">
...
<div class="flex items-center gap-0.5">
  ...
  {#if !platformStore.isWeb}
    <!-- Side Panel is a separate Tauri window — not available in the browser -->
    <Tooltip.Root>
      <Tooltip.Trigger>
        <button
